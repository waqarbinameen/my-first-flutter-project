...
import 'package:school_management_system/auth/login_options_window/view/signup_options_window.dart';
...
class SignupWindow extends StatefulWidget {
  final String? uEmail;
  const SignupWindow({Key? key, this.uEmail}) : super(key: key);
...
class _SignupWindowState extends State<SignupWindow> {
  ...
  @override
  void initState() {
    _uEmail = TextEditingController(
        text: widget.uEmail != null ? widget.uEmail!.toString() : "");
    super.initState();
  }
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            InkWell(
                              onTap: () {
                                Get.off(
                                    () => const SignupOptionsWindow(role: 2));
                              },
                              child: Text(
                                "Here ",
                                style: TextStyle(
